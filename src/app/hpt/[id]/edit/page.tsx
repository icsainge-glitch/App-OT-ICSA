...
import { getHPTById } from "@/actions/db-actions";

export default function EditHPTPage() {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const result = await getHPTById(id);
      setData(result);
      setLoading(false);
    };
    fetchData();
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-4xl">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <h1 className="font-black text-sm md:text-lg uppercase tracking-tighter leading-tight">Editar HPT</h1>
