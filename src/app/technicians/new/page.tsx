...
import { createPersonnelAccount } from "@/actions/db-actions";
            ...
            <CardContent className="p-6 space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="rut_t" className="font-bold uppercase text-[10px] tracking-widest text-muted-foreground">RUT <span className="opacity-60 lowercase font-medium ml-1 tracking-normal">(ej: 12345678-9)</span></Label>
                    <Input id="rut_t" placeholder="12345678-9" value={formData.rut_t} onChange={e => setFormData({ ...formData, rut_t: formatRut(e.target.value) })} className="h-12 font-bold" required />
                  </div>
                  <div className="space-y-2">
